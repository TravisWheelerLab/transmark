pdf("ShuffledORFs.pdf",width=5,height=5)
...
#attach(myhmmdata)
#plot(tblastnfpw, phmmert, main="Shuffled ORF E-values phmmert vs tblastn fpw", cex=0.8, xlab="tblastn - E-value", ylab="phmmert - E-value", col="blue",
#        pch=1, log="xy", xlim=c(1e+2,1e-300), ylim=c(1e+2,1e-300))
...
plot(tblastncons, phmmert, main="Shuffled ORF E-values phmmert vs tblastn fpw", cex=0.8, xlab="tblastn - E-value", ylab="phmmert - E-value", col="blue",
        pch=1, log="xy", xlim=c(1e+2,1e-2), ylim=c(1e+2,1e-2))
